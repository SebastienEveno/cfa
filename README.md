...
### [Equity Valuation](/cfa/study/05-equity-valuation/)

Methods and frameworks for estimating the intrinsic value of equities.

- 🔎 [Application & Processes](/cfa/study/05-equity-valuation/01-application-and-processes/01-introduction/) — Valuation uses, model selection, and analyst responsibilities
- 📊 [Discounted Dividend Valuation](/cfa/study/05-equity-valuation/02-discounted-dividend-valuation/01-introduction/) — Gordon Growth Model, H-model, and multi-stage DDM
- 💵 [Free Cash Flow Valuation](/cfa/study/05-equity-valuation/03-free-cash-flow-valuation/01-introduction/) — FCFF and FCFE models, forecasting, and multi-stage frameworks
- 📉 [Market-Based Valuation](/cfa/study/05-equity-valuation/04-market-based-valuation/01-introduction/) — P/E, P/B, P/S, EV/EBITDA, and other multiples
- 💡 [Residual Income Valuation](/cfa/study/05-equity-valuation/05-residual-income-valuation/01-introduction/) — Economic profit, EVA, and clean surplus accounting
- 🏦 [Private Company Valuation](/cfa/study/05-equity-valuation/06-private-company-valuation/01-introduction/) — Income, market, and asset-based approaches for private firms

---

### [Fixed Income](/cfa/study/06-fixed-income/)

Advanced fixed income analysis — term structure modeling, arbitrage-free valuation, credit risk, and credit derivatives.

- 📐 [Term Structure & Interest Rate Dynamics](/cfa/study/06-fixed-income/01-term-structure-dynamics/01-spot-and-forward-rates/) — Spot rates, forward rates, swap curve, and yield curve factor models
- 🌳 [Arbitrage-Free Valuation](/cfa/study/06-fixed-income/02-arbitrage-free-valuation/01-introduction/) — Binomial interest rate trees, pathwise valuation, and Monte Carlo
- 🔗 [Bonds with Embedded Options](/cfa/study/06-fixed-income/03-valuation-with-embedded-options/01-introduction/) — Callable and putable bonds, OAS, and effective duration
- ⚠️ [Credit Analysis Models](/cfa/study/06-fixed-income/04-credit-analysis-models/01-introduction/) — CVA, structural and reduced-form models, credit spreads
- 🛡️ [Credit Default Swaps](/cfa/study/06-fixed-income/05-credit-default-swaps/02-basic-definitions/) — CDS mechanics, pricing, and index products

---

### [Derivatives](/cfa/study/07-derivatives/)

Pricing and valuation of forward commitments and contingent claims.

- ⏩ [Valuation of Forward Commitments](/cfa/study/07-derivatives/01-valuation-forward-commitments/01-introduction/) — Forwards, futures, FRAs, interest rate, currency, and equity swaps
- 🎲 [Valuation of Contingent Claims](/cfa/study/07-derivatives/02-contingent-claims/01-introduction/) — Binomial model, BSM model, Black model, option Greeks, and implied volatility
...
- Exam tips and practice insights
